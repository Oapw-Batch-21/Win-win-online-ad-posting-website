...
%>
<html>
<head><title>AD-Sense Advertisement Details</title>
...
function delete1()
	{
		...
		{
				document.memberdetail.action="adsdelete.jsp";
		}
		else
		return false;
	}
...
<p align="center"><font size="3">&nbsp;</font><b><u><font color="#000000" face="Verdana" size="2">Online&nbsp; Ads</font></u></b></p>
<center>
...
<th  width="87" align="center"> &nbsp;&nbsp;&nbsp; <b> <font face="Verdana" color="#FFFFFF" size="2">Exp.
  Date</font></b></th>
<th  width="48" align="center"><font face="Verdana" color="#FFFFFF" size="2"><b>Edit</b></font> </th> 
<th  width="56" align="center"><font face="Verdana" color="#FFFFFF"size="2"><b>DELETE</font></b></th>
</tr>
...
<tr>
	...
	<td width="48" align=center><a href="adsedit.jsp?id=<%=no%>"><font size="2" face="Verdana" color="0033CC"><b>Edit</b></font></a></td>

	<td width="60" align=center>
	<a href="adsdelete.jsp?id=<%=no%>" onclick="return delete1()"><font size="2" face="Verdana" color="0033CC"><b>Delete</b></font></a></td>
</tr>
 <%	
 a++;
 }%></table>
