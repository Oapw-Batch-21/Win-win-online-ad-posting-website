		...
		try
			{
				...
				AS_DBCONNECT myConnection=new AS_DBCONNECT();
	   			xdeleteFlag=myConnection.GL_Delete(tablename,ZT_Field_Name,ZT_Field_Type,ZT_Field_Value,nof);
					...
					if(xdeleteFlag==1)
					{ 
						request.setAttribute("update","Advertisement Deleted Successfully");
					    rd=request.getRequestDispatcher("adsdetails.jsp");
					...
					{ %>
						...
						<center>
							<h3>
								<font color="#DF0000"> <% out.println("Advertisement Not yet Deleted........."); %>
								</font>
							</h3>
						</center>
